...
ENV UID=1000 GID=1000 \
  ...
  TYPE=FORGE VERSION=1.12.2 FORGEVERSION=14.23.5.2847 SPONGEBRANCH=STABLE SPONGEVERSION= FABRICVERSION=LATEST LEVEL=world \
  PVP=true DIFFICULTY=hard ENABLE_RCON=true RCON_PORT=25575 RCON_PASSWORD=GHOSTS4 \
